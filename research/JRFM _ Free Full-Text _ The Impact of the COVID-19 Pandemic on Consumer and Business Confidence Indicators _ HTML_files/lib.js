...
{if(""==$("#topic-query").val()&&"all"==$("#topic-journal").val()&&"open"==$("#topic-status").val()&&"all"==$("#topic-category").val()){$('#topics_search .search-input-label').hide();}
else{$('#topics_search .search-input-label').show();}}
...
else{if(parent_div!='undefined'){$('#'+parent_div).hide();}}};if(parent_div!='undefined'){img.onerror=function(){$('#'+parent_div).hide();};}}}
...
return location.href="/journal/"+journal+"/"+($(this).attr('id').replace('cmd_',''));});$('#cmd_special_issue_proposal').click(function(){var journal=$('#opt_journal').val();if(!journal){return;}
return location.href="/journalproposal/sendproposalspecialissue/"+journal;});$('#cmd_volunteer').click(function(){var journal=$('#opt_journal').val();if(!journal){return;}
...
return moment;}
var getDuration=function(grammar,layout,plagiarism,level){var m=moment();var days=0;var result="";if(layout){days+=1;}
if(plagiarism){days+=1;}
if(grammar){switch(level){case "regular":days+=5;break;case "express":days+=1;break;case "specialist":days+=5;break}}
return "Editing will be completed within "+days+" working day(s) after payment";}
var get_price=function(word_num,has_manuscript,grammar,layout,plagiarism,level,rate){var price=0;if(grammar){switch(level){case "regular":price+=105+word_num*0.02;break;case "express":price+=140+word_num*0.03;break;case "specialist":price+=180+word_num*0.04;break}}
if(layout){price+=75;}
